...
import routesRecipe from './routes/recipe.routes';
import { socketChatMessages } from './sockets/chat_socket';
import { socketChatMessagesRecipe } from './sockets/recipe_chat_socket';
...
export class App {
    ...
    private middlewares(){
        ...
        this.app.use( express.static( path.resolve('uploads/recipes')));
    ...
    private routes(){
        ...
        this.app.use( this.apiRoutes.recipe, routesRecipe );
